...
#define NESTED_PROPERTY_INFO_BOND(...)                                                        \
    ...
    .base        = {.meta_type    = &nm_meta_type_nested_property_info,                       \
...
static const NMMetaNestedPropertyInfo meta_nested_property_infos_bond[] = {
    {NESTED_PROPERTY_INFO_BOND(.property_name  = NM_SETTING_BOND_OPTIONS,
                               .property_alias = "mode",
...
#define DEFINE_PROPERTY_TYPE(...) (&((NMMetaPropertyType){__VA_ARGS__}))

#define DEFINE_PROPERTY_TYP_DATA(...) (&((NMMetaPropertyTypData){__VA_ARGS__}))
...
#define DEFINE_PROPERTY_TYP_DATA_SUBTYPE(stype, ...) \
    DEFINE_PROPERTY_TYP_DATA(PROPERTY_TYP_DATA_SUBTYPE(stype, __VA_ARGS__), )
...
#define MULTILIST_GET_NUM_FCN_U32(type, func) \
    (((func) == ((guint32(*)(type *))(func))) ? ((guint32(*)(NMSetting *))(func)) : NULL)
#define MULTILIST_GET_NUM_FCN_U(type, func) \
    (((func) == ((guint(*)(type *))(func))) ? ((guint(*)(NMSetting *))(func)) : NULL)
#define MULTILIST_ADD_FCN(type, func)                        \
    (((func) == ((gboolean(*)(type *, const char *))(func))) \
         ? ((gboolean(*)(NMSetting *, const char *))(func))  \
         : NULL)
#define MULTILIST_ADD2_FCN(type, func)                    \
    (((func) == ((void (*)(type *, const char *))(func))) \
         ? ((void (*)(NMSetting *, const char *))(func))  \
         : NULL)
#define MULTILIST_REMOVE_BY_IDX_FCN_U32(type, func)                                             \
    (((func) == ((void (*)(type *, guint32))(func))) ? ((void (*)(NMSetting *, guint32))(func)) \
                                                     : NULL)
#define MULTILIST_REMOVE_BY_IDX_FCN_S(type, func) \
    (((func) == ((void (*)(type *, int))(func))) ? ((void (*)(NMSetting *, int))(func)) : NULL)
#define MULTILIST_REMOVE_BY_IDX_FCN_U(type, func) \
    (((func) == ((void (*)(type *, guint))(func))) ? ((void (*)(NMSetting *, guint))(func)) : NULL)
#define MULTILIST_REMOVE_BY_VALUE_FCN(type, func)            \
    (((func) == ((gboolean(*)(type *, const char *))(func))) \
         ? ((gboolean(*)(NMSetting *, const char *))(func))  \
         : NULL)
#define MULTILIST_CLEAR_EMPTYUNSET_FCN(type, func)                                                \
    (((func) == ((void (*)(type *, gboolean))(func))) ? ((void (*)(NMSetting *, gboolean))(func)) \
                                                      : NULL)

#define OBJLIST_GET_NUM_FCN(type, func) \
    (((func) == ((guint(*)(type *))(func))) ? ((guint(*)(NMSetting *))(func)) : NULL)
#define OBJLIST_CLEAR_ALL_FCN(type, func) \
    (((func) == ((void (*)(type *))(func))) ? ((void (*)(NMSetting *))(func)) : NULL)
#define OBJLIST_REMOVE_BY_IDX_FCN_U(type, func) \
    (((func) == ((void (*)(type *, guint))(func))) ? ((void (*)(NMSetting *, guint))(func)) : NULL)
#define OBJLIST_REMOVE_BY_IDX_FCN_S(type, func) \
    (((func) == ((void (*)(type *, int))(func))) ? ((void (*)(NMSetting *, int))(func)) : NULL)
...
#define PROPERTY_INFO_INIT(name, doc, ...)                                             \
    {                                                                                  \
        ...
        .property_name = name, .describe_doc = doc, __VA_ARGS__                        \
    }

#define PROPERTY_INFO(name, doc, ...) \
    (&((const NMMetaPropertyInfo) PROPERTY_INFO_INIT(name, doc, __VA_ARGS__)))

#define PROPERTY_INFO_WITH_DESC(name, ...) PROPERTY_INFO(name, DESCRIBE_DOC_##name, ##__VA_ARGS__)

#define ENUM_VALUE_INFOS(...)         \
    (((const NMUtilsEnumValueInfo[]){ \
        __VA_ARGS__{                  \
            .nick = NULL,             \
        },                            \
    }))
#define INT_VALUE_INFOS(...)             \
    (((const NMMetaUtilsIntValueInfo[]){ \
        __VA_ARGS__{                     \
            .nick = NULL,                \
        },                               \
    }))
...
#define TEAM_DESCRIBE_MESSAGE                                                                    \
    N_("nmcli can accepts both direct JSON configuration data and a file name containing "       \
       ...
       "{ \"device\": \"team0\", \"runner\": {\"name\": \"roundrobin\"}, \"ports\": {\"eth1\": " \
       "{}, \"eth2\": {}} }\n"                                                                   \
...
#define DEFINE_DCB_PROPRITY_PROPERTY_TYPE                                                         \
    ...
    .property_typ_data =                                                                          \
        DEFINE_PROPERTY_TYP_DATA_SUBTYPE(gobject_int,                                             \
...
static const NMMetaPropertyTypData _ptd_gobject_int_timeout = {
    PROPERTY_TYP_DATA_SUBTYPE(gobject_int,
                              .value_infos = INT_VALUE_INFOS(
                                  {
                                      .value.i64 = 0,
                                      .nick      = "default",
...
static const NMMetaPropertyInfo *const property_infos_802_1X[] = {
    PROPERTY_INFO_WITH_DESC(NM_SETTING_802_1X_OPTIONAL, .property_type = &_pt_gobject_bool, ),
    PROPERTY_INFO_WITH_DESC(
        ...
        .property_typ_data = DEFINE_PROPERTY_TYP_DATA(
            PROPERTY_TYP_DATA_SUBTYPE(
                multilist,
                .get_num_fcn_u32 = MULTILIST_GET_NUM_FCN_U32(NMSetting8021x,
                                                             nm_setting_802_1x_get_num_eap_methods),
                .add_fcn = MULTILIST_ADD_FCN(NMSetting8021x, nm_setting_802_1x_add_eap_method),
                .remove_by_idx_fcn_u32 =
                    MULTILIST_REMOVE_BY_IDX_FCN_U32(NMSetting8021x,
                                                    nm_setting_802_1x_remove_eap_method),
                .remove_by_value_fcn =
                    MULTILIST_REMOVE_BY_VALUE_FCN(NMSetting8021x,
                                                  nm_setting_802_1x_remove_eap_method_by_value),
                .strsplit_plain = TRUE, ),
            .values_static =
                NM_MAKE_STRV("leap", "md5", "tls", "peap", "ttls", "sim", "fast", "pwd"), ), ),
    PROPERTY_INFO_WITH_DESC(NM_SETTING_802_1X_IDENTITY, .property_type = &_pt_gobject_string, ),
    PROPERTY_INFO_WITH_DESC(NM_SETTING_802_1X_ANONYMOUS_IDENTITY,
                            .property_type = &_pt_gobject_string, ),
    PROPERTY_INFO_WITH_DESC(NM_SETTING_802_1X_PAC_FILE, .property_type = &_pt_gobject_string, ),
    PROPERTY_INFO_WITH_DESC(
    ...
    PROPERTY_INFO_WITH_DESC(NM_SETTING_802_1X_CA_PATH, .property_type = &_pt_gobject_string, ),
    ...
    PROPERTY_INFO_WITH_DESC(
        ...
        .property_typ_data = DEFINE_PROPERTY_TYP_DATA(
            PROPERTY_TYP_DATA_SUBTYPE(
                multilist,
                .get_num_fcn_u32 =
                    MULTILIST_GET_NUM_FCN_U32(NMSetting8021x,
                                              nm_setting_802_1x_get_num_altsubject_matches),
                .add_fcn =
                    MULTILIST_ADD_FCN(NMSetting8021x, nm_setting_802_1x_add_altsubject_match),
                .remove_by_idx_fcn_u32 =
                    MULTILIST_REMOVE_BY_IDX_FCN_U32(NMSetting8021x,
                                                    nm_setting_802_1x_remove_altsubject_match),
                .remove_by_value_fcn = MULTILIST_REMOVE_BY_VALUE_FCN(
                    NMSetting8021x,
                    nm_setting_802_1x_remove_altsubject_match_by_value),
                .strsplit_plain = TRUE, ), ), ),
    PROPERTY_INFO_WITH_DESC(NM_SETTING_802_1X_DOMAIN_SUFFIX_MATCH,
                            .property_type = &_pt_gobject_string, ),
    PROPERTY_INFO_WITH_DESC(NM_SETTING_802_1X_DOMAIN_MATCH, .property_type = &_pt_gobject_string, ),
    PROPERTY_INFO_WITH_DESC(
    ...
    PROPERTY_INFO_WITH_DESC(
        ...
        .property_type     = &_pt_gobject_string,
        .property_typ_data = DEFINE_PROPERTY_TYP_DATA(.values_static = NM_MAKE_STRV("0", "1"), ), ),
    PROPERTY_INFO_WITH_DESC(
    ...
    PROPERTY_INFO_WITH_DESC(
        ...
        .property_type = &_pt_gobject_string,
        .property_typ_data =
            DEFINE_PROPERTY_TYP_DATA(.values_static = NM_MAKE_STRV("0", "1", "2", "3"), ), ),
    PROPERTY_INFO_WITH_DESC(
    ...
    PROPERTY_INFO_WITH_DESC(NM_SETTING_802_1X_PHASE2_AUTH,
                            .property_type = &_pt_gobject_string,
                            .property_typ_data =
                                DEFINE_PROPERTY_TYP_DATA(.values_static = NM_MAKE_STRV("pap",
                                                                                       "chap",
                                                                                       "mschap",
                                                                                       "mschapv2",
                                                                                       "gtc",
    ...
    PROPERTY_INFO_WITH_DESC(
        ...
        .property_type = &_pt_gobject_string,
        .property_typ_data =
            DEFINE_PROPERTY_TYP_DATA(.values_static =
                                         NM_MAKE_STRV("md5", "mschapv2", "otp", "gtc", "tls"), ), ),
    PROPERTY_INFO_WITH_DESC(
    ...
    PROPERTY_INFO_WITH_DESC(
        ...
        .property_typ_data = DEFINE_PROPERTY_TYP_DATA(
            PROPERTY_TYP_DATA_SUBTYPE(
                multilist,
                .get_num_fcn_u32 = MULTILIST_GET_NUM_FCN_U32(
                    NMSetting8021x,
                    nm_setting_802_1x_get_num_phase2_altsubject_matches),
                .add_fcn               = MULTILIST_ADD_FCN(NMSetting8021x,
                                             nm_setting_802_1x_add_phase2_altsubject_match),
                .remove_by_idx_fcn_u32 = MULTILIST_REMOVE_BY_IDX_FCN_U32(
                    NMSetting8021x,
    ...
    PROPERTY_INFO_WITH_DESC(
        ...
        .property_typ_data =
            DEFINE_PROPERTY_TYP_DATA_SUBTYPE(gobject_bytes, .legacy_format = TRUE, ), ),
    ...
    PROPERTY_INFO_WITH_DESC(NM_SETTING_802_1X_AUTH_TIMEOUT, .property_type = &_pt_gobject_int, ),
    NULL};
...
static const NMMetaPropertyInfo *const property_infos_ADSL[] = {
    ...
    PROPERTY_INFO_WITH_DESC(NM_SETTING_ADSL_PROTOCOL,
                            ...
                            .property_type  = &_pt_gobject_string,
                            .property_typ_data =
                                DEFINE_PROPERTY_TYP_DATA(.values_static = NM_MAKE_STRV(
    ...
    PROPERTY_INFO_WITH_DESC(
        ...
        .property_type     = &_pt_gobject_string,
        .property_typ_data = DEFINE_PROPERTY_TYP_DATA(.values_static = NM_MAKE_STRV(
                                                          NM_SETTING_ADSL_ENCAPSULATION_VCMUX,
                                                          NM_SETTING_ADSL_ENCAPSULATION_LLC), ), ),
    PROPERTY_INFO_WITH_DESC(NM_SETTING_ADSL_VPI, .property_type = &_pt_gobject_int, ),
    PROPERTY_INFO_WITH_DESC(NM_SETTING_ADSL_VCI, .property_type = &_pt_gobject_int, ),
    NULL};
...
static const NMMetaPropertyInfo property_info_BOND_OPTIONS = PROPERTY_INFO_INIT(
    NM_SETTING_BOND_OPTIONS,
    DESCRIBE_DOC_NM_SETTING_BOND_OPTIONS,
    ...
    .property_typ_data = DEFINE_PROPERTY_TYP_DATA(
        PROPERTY_TYP_DATA_SUBTYPE(optionlist, .set_fcn = _nm_meta_setting_bond_add_option, ),
        .nested = &nm_meta_property_typ_data_bond, ), );

static const NMMetaPropertyInfo *const property_infos_BOND[] = {&property_info_BOND_OPTIONS, NULL};
...
static const NMMetaPropertyInfo *const property_infos_BRIDGE[] = {
    ...
    PROPERTY_INFO_WITH_DESC(
        ...
        .property_typ_data =
            DEFINE_PROPERTY_TYP_DATA(.values_static =
                                         NM_MAKE_STRV("auto", "disabled", "enabled"), ), ),
    PROPERTY_INFO_WITH_DESC(NM_SETTING_BRIDGE_VLAN_FILTERING, .property_type = &_pt_gobject_bool, ),
    ...
    PROPERTY_INFO_WITH_DESC(
        ...
        .hide_if_default = TRUE,
        .property_typ_data =
            DEFINE_PROPERTY_TYP_DATA(.values_static = NM_MAKE_STRV("802.1Q", "802.1ad"), ), ),
    PROPERTY_INFO_WITH_DESC(
        ...
        .property_typ_data = DEFINE_PROPERTY_TYP_DATA(
            PROPERTY_TYP_DATA_SUBTYPE(
                objlist,
                .get_num_fcn =
                    OBJLIST_GET_NUM_FCN(NMSettingBridge, nm_setting_bridge_get_num_vlans),
                .clear_all_fcn =
                    OBJLIST_CLEAR_ALL_FCN(NMSettingBridge, nm_setting_bridge_clear_vlans),
    ...
    PROPERTY_INFO_WITH_DESC(
        ...
        .property_typ_data = DEFINE_PROPERTY_TYP_DATA(
            PROPERTY_TYP_DATA_SUBTYPE(
                objlist,
                .get_num_fcn =
                    OBJLIST_GET_NUM_FCN(NMSettingBridgePort, nm_setting_bridge_port_get_num_vlans),
                .clear_all_fcn =
                    OBJLIST_CLEAR_ALL_FCN(NMSettingBridgePort, nm_setting_bridge_port_clear_vlans),
                .obj_to_str_fcn = _objlist_obj_to_str_fcn_bridge_vlans,
                .set_fcn        = _objlist_set_fcn_bridge_vlans, ), ), ),
    NULL};
...
static const NMMetaPropertyInfo *const property_infos_CDMA[] = {
    PROPERTY_INFO_WITH_DESC(NM_SETTING_CDMA_NUMBER, .property_type = &_pt_gobject_string, ),
...
static const NMMetaPropertyInfo *const property_infos_CONNECTION[] = {
    ...
    PROPERTY_INFO_WITH_DESC(NM_SETTING_CONNECTION_STABLE_ID,
                            .property_type = &_pt_gobject_string, ),
    [_NM_META_PROPERTY_TYPE_CONNECTION_TYPE] = PROPERTY_INFO_WITH_DESC(
    ...
    PROPERTY_INFO_WITH_DESC(
        ...
        .property_typ_data = DEFINE_PROPERTY_TYP_DATA(
            PROPERTY_TYP_DATA_SUBTYPE(
                ...
                .remove_by_idx_fcn_u32 =
                    MULTILIST_REMOVE_BY_IDX_FCN_U32(NMSettingConnection,
                ...
                .strsplit_plain      = TRUE, ), ), ),
    PROPERTY_INFO_WITH_DESC(NM_SETTING_CONNECTION_ZONE, .property_type = &_pt_gobject_string, ),
    PROPERTY_INFO_WITH_DESC(
    ...
    PROPERTY_INFO_WITH_DESC(
        ...
        .property_typ_data = DEFINE_PROPERTY_TYP_DATA(
            PROPERTY_TYP_DATA_SUBTYPE(
                ...
                .add_fcn =
                    MULTILIST_ADD_FCN(NMSettingConnection, nm_setting_connection_add_secondary),
                .remove_by_idx_fcn_u32 =
                    MULTILIST_REMOVE_BY_IDX_FCN_U32(NMSettingConnection,
                                                    nm_setting_connection_remove_secondary),
                .remove_by_value_fcn =
                    MULTILIST_REMOVE_BY_VALUE_FCN(NMSettingConnection,
    ...
    PROPERTY_INFO_WITH_DESC(
        ...
        .property_type = DEFINE_PROPERTY_TYPE(.get_fcn = _get_fcn_connection_metered,
                                              .set_fcn = _set_fcn_connection_metered, ),
        .property_typ_data =
            DEFINE_PROPERTY_TYP_DATA(.values_static = NM_MAKE_STRV("yes", "no", "unknown"), ), ),
    PROPERTY_INFO_WITH_DESC(
...
static const NMMetaPropertyInfo *const property_infos_DCB[] = {
    PROPERTY_INFO_WITH_DESC(NM_SETTING_DCB_APP_FCOE_FLAGS, .property_type = &_pt_dcb_flags, ),
    PROPERTY_INFO_WITH_DESC(NM_SETTING_DCB_APP_FCOE_PRIORITY, DEFINE_DCB_PROPRITY_PROPERTY_TYPE),
    ...
    PROPERTY_INFO_WITH_DESC(NM_SETTING_DCB_APP_ISCSI_FLAGS, .property_type = &_pt_dcb_flags, ),
    PROPERTY_INFO_WITH_DESC(NM_SETTING_DCB_APP_ISCSI_PRIORITY, DEFINE_DCB_PROPRITY_PROPERTY_TYPE),
    PROPERTY_INFO_WITH_DESC(NM_SETTING_DCB_APP_FIP_FLAGS, .property_type = &_pt_dcb_flags, ),
    PROPERTY_INFO_WITH_DESC(NM_SETTING_DCB_APP_FIP_PRIORITY, DEFINE_DCB_PROPRITY_PROPERTY_TYPE),
    ...
    PROPERTY_INFO_WITH_DESC(NM_SETTING_DCB_PRIORITY_GROUP_FLAGS, .property_type = &_pt_dcb_flags, ),
...
#define PROPERTY_INFO_ETHTOOL(xname)     \
    PROPERTY_INFO(                       \
        NM_ETHTOOL_OPTNAME_##xname,      \
        NULL,                            \
        .property_type   = &_pt_ethtool, \
        .hide_if_default = TRUE,         \
        .property_typ_data =             \
            DEFINE_PROPERTY_TYP_DATA_SUBTYPE(ethtool, .ethtool_id = NM_ETHTOOL_ID_##xname, ), )
...
static const NMMetaPropertyInfo *const property_infos_GSM[] = {
    PROPERTY_INFO_WITH_DESC(NM_SETTING_GSM_AUTO_CONFIG, .property_type = &_pt_gobject_bool, ),
    PROPERTY_INFO_WITH_DESC(NM_SETTING_GSM_NUMBER, .property_type = &_pt_gobject_string, ),
    ...
    PROPERTY_INFO_WITH_DESC(NM_SETTING_GSM_APN,
                            ...
                            .prompt         = N_("APN"),
                            .property_type  = &_pt_gobject_string, ),
    PROPERTY_INFO_WITH_DESC(NM_SETTING_GSM_NETWORK_ID, .property_type = &_pt_gobject_string, ),
    PROPERTY_INFO_WITH_DESC(NM_SETTING_GSM_PIN,
                            .is_secret     = TRUE,
                            .property_type = &_pt_gobject_string, ),
    PROPERTY_INFO_WITH_DESC(NM_SETTING_GSM_PIN_FLAGS, .property_type = &_pt_gobject_secret_flags, ),
    PROPERTY_INFO_WITH_DESC(NM_SETTING_GSM_HOME_ONLY, .property_type = &_pt_gobject_bool, ),
    PROPERTY_INFO_WITH_DESC(NM_SETTING_GSM_DEVICE_ID, .property_type = &_pt_gobject_string, ),
    PROPERTY_INFO_WITH_DESC(NM_SETTING_GSM_SIM_ID, .property_type = &_pt_gobject_string, ),
    PROPERTY_INFO_WITH_DESC(NM_SETTING_GSM_SIM_OPERATOR_ID,
                            .property_type =
                                DEFINE_PROPERTY_TYPE(.get_fcn = _get_fcn_gobject,
...
static const NMMetaPropertyInfo *const property_infos_INFINIBAND[] = {
    ...
    PROPERTY_INFO_WITH_DESC(
        ...
        .property_type  = &_pt_gobject_string,
        .property_typ_data =
            DEFINE_PROPERTY_TYP_DATA(.values_static = NM_MAKE_STRV("datagram", "connected"), ), ),
    PROPERTY_INFO_WITH_DESC(NM_SETTING_INFINIBAND_P_KEY,
                            .is_cli_option  = TRUE,
                            .property_alias = "p-key",
                            .prompt         = N_("P_KEY [none]"),
                            .property_type =
                                DEFINE_PROPERTY_TYPE(.get_fcn = _get_fcn_infiniband_p_key,
...
static const NMMetaPropertyInfo *const property_infos_IP4_CONFIG[] = {
    PROPERTY_INFO(NM_SETTING_IP_CONFIG_METHOD,
                  DESCRIBE_DOC_NM_SETTING_IP4_CONFIG_METHOD,
                  .property_type = DEFINE_PROPERTY_TYPE(.get_fcn = _get_fcn_gobject,
    ...
    PROPERTY_INFO(
        ...
        DESCRIBE_DOC_NM_SETTING_IP4_CONFIG_DNS,
        .describe_message  = N_("Enter a list of IPv4 addresses of DNS servers.\n\n"
        ...
        .property_typ_data = DEFINE_PROPERTY_TYP_DATA(
            PROPERTY_TYP_DATA_SUBTYPE(
                multilist,
                .get_num_fcn_u =
                    MULTILIST_GET_NUM_FCN_U(NMSettingIPConfig, nm_setting_ip_config_get_num_dns),
                .add_fcn = MULTILIST_ADD_FCN(NMSettingIPConfig, nm_setting_ip_config_add_dns),
                .remove_by_idx_fcn_s =
                    MULTILIST_REMOVE_BY_IDX_FCN_S(NMSettingIPConfig,
                                                  nm_setting_ip_config_remove_dns),
                .remove_by_value_fcn =
                    MULTILIST_REMOVE_BY_VALUE_FCN(NMSettingIPConfig,
                                                  nm_setting_ip_config_remove_dns_by_value),
                .validate2_fcn  = _multilist_validate2_fcn_ip_config_dns,
                .strsplit_plain = TRUE, ), ), ),
    PROPERTY_INFO(
        NM_SETTING_IP_CONFIG_DNS_SEARCH,
        DESCRIBE_DOC_NM_SETTING_IP4_CONFIG_DNS_SEARCH,
        .property_type     = &_pt_multilist,
        .property_typ_data = DEFINE_PROPERTY_TYP_DATA(
            PROPERTY_TYP_DATA_SUBTYPE(
                multilist,
                .get_num_fcn_u = MULTILIST_GET_NUM_FCN_U(NMSettingIPConfig,
                                                         nm_setting_ip_config_get_num_dns_searches),
                .add_fcn =
                    MULTILIST_ADD_FCN(NMSettingIPConfig, nm_setting_ip_config_add_dns_search),
                .remove_by_idx_fcn_s =
                    MULTILIST_REMOVE_BY_IDX_FCN_S(NMSettingIPConfig,
    ...
    PROPERTY_INFO(
        ...
        DESCRIBE_DOC_NM_SETTING_IP4_CONFIG_DNS_OPTIONS,
        .property_type     = &_pt_multilist,
        .property_typ_data = DEFINE_PROPERTY_TYP_DATA(
            PROPERTY_TYP_DATA_SUBTYPE(
                multilist,
                ...
                .clear_emptyunset_fcn =
                    MULTILIST_CLEAR_EMPTYUNSET_FCN(NMSettingIPConfig,
                                                   nm_setting_ip_config_clear_dns_options),
                .strsplit_plain = TRUE, ),
            .is_default_fcn = _is_default_func_ip_config_dns_options, ), ),
    PROPERTY_INFO(NM_SETTING_IP_CONFIG_DNS_PRIORITY,
                  DESCRIBE_DOC_NM_SETTING_IP4_CONFIG_DNS_PRIORITY,
                  .property_type = &_pt_gobject_int, ),
    PROPERTY_INFO(
        ...
        .describe_message  = N_("Enter a list of IPv4 addresses formatted as:\n"
                               "  ip[/prefix], ip[/prefix],...\n"
        ...
        .property_typ_data = DEFINE_PROPERTY_TYP_DATA(
            PROPERTY_TYP_DATA_SUBTYPE(
                objlist,
                .get_num_fcn =
                    OBJLIST_GET_NUM_FCN(NMSettingIPConfig, nm_setting_ip_config_get_num_addresses),
                .clear_all_fcn =
                    OBJLIST_CLEAR_ALL_FCN(NMSettingIPConfig, nm_setting_ip_config_clear_addresses),
                .obj_to_str_fcn = _objlist_obj_to_str_fcn_ip_config_addresses,
                .set_fcn        = _objlist_set_fcn_ip_config_addresses,
                .remove_by_idx_fcn_s =
                    OBJLIST_REMOVE_BY_IDX_FCN_S(NMSettingIPConfig,
                                                nm_setting_ip_config_remove_address),
                .strsplit_plain = TRUE, ), ), ),
    PROPERTY_INFO(NM_SETTING_IP_CONFIG_GATEWAY,
                  DESCRIBE_DOC_NM_SETTING_IP4_CONFIG_GATEWAY,
                  .is_cli_option  = TRUE,
                  .property_alias = "gw4",
                  .prompt         = N_("IPv4 gateway [none]"),
                  .property_type  = DEFINE_PROPERTY_TYPE(.get_fcn = _get_fcn_gobject,
                                                        .set_fcn = _set_fcn_ip_config_gateway, ), ),
    PROPERTY_INFO(NM_SETTING_IP_CONFIG_ROUTES,
                  DESCRIBE_DOC_NM_SETTING_IP4_CONFIG_ROUTES,
                  .describe_message =
                  ...
                  .property_typ_data = DEFINE_PROPERTY_TYP_DATA(
                      PROPERTY_TYP_DATA_SUBTYPE(
                          objlist,
                          .get_num_fcn    = OBJLIST_GET_NUM_FCN(NMSettingIPConfig,
                                                             nm_setting_ip_config_get_num_routes),
                          .clear_all_fcn  = OBJLIST_CLEAR_ALL_FCN(NMSettingIPConfig,
                          ...
                          .strsplit_plain                = TRUE, ), ), ),
    PROPERTY_INFO(NM_SETTING_IP_CONFIG_ROUTE_METRIC,
                  DESCRIBE_DOC_NM_SETTING_IP4_CONFIG_ROUTE_METRIC,
                  .property_type = &_pt_gobject_int, ),
    PROPERTY_INFO(NM_SETTING_IP_CONFIG_ROUTE_TABLE,
                  DESCRIBE_DOC_NM_SETTING_IP4_CONFIG_ROUTE_TABLE,
                  .property_type = &_pt_gobject_int,
                  .property_typ_data =
                      DEFINE_PROPERTY_TYP_DATA_SUBTYPE(gobject_int,
                                                       .value_infos = INT_VALUE_INFOS(
    ...
    PROPERTY_INFO(
        ...
        .property_typ_data = DEFINE_PROPERTY_TYP_DATA(
            PROPERTY_TYP_DATA_SUBTYPE(
                ...
                .remove_by_idx_fcn_u =
                    OBJLIST_REMOVE_BY_IDX_FCN_U(NMSettingIPConfig,
                                                nm_setting_ip_config_remove_routing_rule), ), ), ),
    PROPERTY_INFO(NM_SETTING_IP_CONFIG_IGNORE_AUTO_ROUTES,
                  DESCRIBE_DOC_NM_SETTING_IP4_CONFIG_IGNORE_AUTO_ROUTES,
                  .property_type = &_pt_gobject_bool, ),
    PROPERTY_INFO(NM_SETTING_IP_CONFIG_IGNORE_AUTO_DNS,
                  DESCRIBE_DOC_NM_SETTING_IP4_CONFIG_IGNORE_AUTO_DNS,
                  .property_type = &_pt_gobject_bool, ),
    PROPERTY_INFO_WITH_DESC(NM_SETTING_IP4_CONFIG_DHCP_CLIENT_ID,
                            .property_type = &_pt_gobject_string, ),
    PROPERTY_INFO(NM_SETTING_IP_CONFIG_DHCP_IAID,
                  DESCRIBE_DOC_NM_SETTING_IP4_CONFIG_DHCP_IAID,
                  .property_type = &_pt_gobject_string, ),
    PROPERTY_INFO(NM_SETTING_IP_CONFIG_DHCP_TIMEOUT,
                  DESCRIBE_DOC_NM_SETTING_IP4_CONFIG_DHCP_TIMEOUT,
                  .property_type     = &_pt_gobject_int,
                  .property_typ_data = &_ptd_gobject_int_timeout, ),
    PROPERTY_INFO(NM_SETTING_IP_CONFIG_DHCP_SEND_HOSTNAME,
                  DESCRIBE_DOC_NM_SETTING_IP4_CONFIG_DHCP_SEND_HOSTNAME,
                  .property_type = &_pt_gobject_bool, ),
    PROPERTY_INFO(NM_SETTING_IP_CONFIG_DHCP_HOSTNAME,
                  DESCRIBE_DOC_NM_SETTING_IP4_CONFIG_DHCP_HOSTNAME,
                  .property_type = &_pt_gobject_string, ),
    PROPERTY_INFO_WITH_DESC(NM_SETTING_IP4_CONFIG_DHCP_FQDN,
                            .property_type = &_pt_gobject_string, ),
    PROPERTY_INFO(NM_SETTING_IP_CONFIG_DHCP_HOSTNAME_FLAGS,
                  DESCRIBE_DOC_NM_SETTING_IP4_CONFIG_DHCP_HOSTNAME_FLAGS,
                  .property_type     = &_pt_gobject_enum,
                  .property_typ_data = DEFINE_PROPERTY_TYP_DATA(
                      PROPERTY_TYP_DATA_SUBTYPE(gobject_enum,
                                                .get_gtype = nm_dhcp_hostname_flags_get_type, ), )),
    PROPERTY_INFO(NM_SETTING_IP_CONFIG_NEVER_DEFAULT,
                  DESCRIBE_DOC_NM_SETTING_IP4_CONFIG_NEVER_DEFAULT,
                  .property_type = &_pt_gobject_bool, ),
    PROPERTY_INFO(NM_SETTING_IP_CONFIG_MAY_FAIL,
                  DESCRIBE_DOC_NM_SETTING_IP4_CONFIG_MAY_FAIL,
                  .property_type = &_pt_gobject_bool, ),
    PROPERTY_INFO(NM_SETTING_IP_CONFIG_DAD_TIMEOUT,
                  DESCRIBE_DOC_NM_SETTING_IP4_CONFIG_DAD_TIMEOUT,
                  .property_type = &_pt_gobject_int,
                  .property_typ_data =
                      DEFINE_PROPERTY_TYP_DATA_SUBTYPE(gobject_int,
                                                       .value_infos = INT_VALUE_INFOS(
    ...
    PROPERTY_INFO(
        ...
        .property_typ_data = DEFINE_PROPERTY_TYP_DATA(
            PROPERTY_TYP_DATA_SUBTYPE(
                multilist,
                .get_num_fcn_u =
                    MULTILIST_GET_NUM_FCN_U(NMSettingIPConfig,
                                            _multilist_get_num_fcn_ip_config_dhcp_reject_servers),
                .add2_fcn = MULTILIST_ADD2_FCN(NMSettingIPConfig,
                                               nm_setting_ip_config_add_dhcp_reject_server),
                .remove_by_idx_fcn_u =
                    MULTILIST_REMOVE_BY_IDX_FCN_U(NMSettingIPConfig,
...
static const NMMetaPropertyInfo *const property_infos_IP6_CONFIG[] = {
    PROPERTY_INFO(NM_SETTING_IP_CONFIG_METHOD,
                  DESCRIBE_DOC_NM_SETTING_IP6_CONFIG_METHOD,
                  .property_type = DEFINE_PROPERTY_TYPE(.get_fcn = _get_fcn_gobject,
                                                        .set_fcn = _set_fcn_ip_config_method, ),
                  .property_typ_data =
                      DEFINE_PROPERTY_TYP_DATA(.values_static = NM_MAKE_STRV(
    ...
    PROPERTY_INFO(
        ...
        .describe_message  = N_("Enter a list of IPv6 addresses of DNS servers.  If the IPv6 "
    ...
    PROPERTY_INFO(
        NM_SETTING_IP_CONFIG_DNS_SEARCH,
        DESCRIBE_DOC_NM_SETTING_IP6_CONFIG_DNS_SEARCH,
        .property_type     = &_pt_multilist,
        .property_typ_data = DEFINE_PROPERTY_TYP_DATA(
            PROPERTY_TYP_DATA_SUBTYPE(
                multilist,
    ...
    PROPERTY_INFO(
        NM_SETTING_IP_CONFIG_DNS_OPTIONS,
        DESCRIBE_DOC_NM_SETTING_IP6_CONFIG_DNS_OPTIONS,
        .property_type     = &_pt_multilist,
        .property_typ_data = DEFINE_PROPERTY_TYP_DATA(
            PROPERTY_TYP_DATA_SUBTYPE(
                multilist,
            ...
            .is_default_fcn = _is_default_func_ip_config_dns_options, ), ),
    PROPERTY_INFO(NM_SETTING_IP_CONFIG_DNS_PRIORITY,
                  DESCRIBE_DOC_NM_SETTING_IP6_CONFIG_DNS_PRIORITY,
                  .property_type = &_pt_gobject_int, ),
    PROPERTY_INFO(
        NM_SETTING_IP_CONFIG_ADDRESSES,
        ...
        .property_typ_data = DEFINE_PROPERTY_TYP_DATA(
            PROPERTY_TYP_DATA_SUBTYPE(
                ...
                .strsplit_plain = TRUE, ), ), ),
    PROPERTY_INFO(NM_SETTING_IP_CONFIG_GATEWAY,
                  DESCRIBE_DOC_NM_SETTING_IP6_CONFIG_GATEWAY,
                  .is_cli_option  = TRUE,
                  .property_alias = "gw6",
                  ...
                  .property_type  = DEFINE_PROPERTY_TYPE(.get_fcn = _get_fcn_gobject,
                                                        .set_fcn = _set_fcn_ip_config_gateway, ), ),
    PROPERTY_INFO(NM_SETTING_IP_CONFIG_ROUTES,
                  DESCRIBE_DOC_NM_SETTING_IP6_CONFIG_ROUTES,
                  .describe_message =
                  ...
                  .property_typ_data = DEFINE_PROPERTY_TYP_DATA(
                      PROPERTY_TYP_DATA_SUBTYPE(
                          ...
                          .strsplit_plain                = TRUE, ), ), ),
    PROPERTY_INFO(NM_SETTING_IP_CONFIG_ROUTE_METRIC,
                  DESCRIBE_DOC_NM_SETTING_IP6_CONFIG_ROUTE_METRIC,
                  .property_type = &_pt_gobject_int, ),
    PROPERTY_INFO(NM_SETTING_IP_CONFIG_ROUTE_TABLE,
                  DESCRIBE_DOC_NM_SETTING_IP6_CONFIG_ROUTE_TABLE,
                  .property_type = &_pt_gobject_int,
                  .property_typ_data =
                      DEFINE_PROPERTY_TYP_DATA_SUBTYPE(gobject_int,
                                                       .value_infos = INT_VALUE_INFOS(
            ...
            PROPERTY_TYP_DATA_SUBTYPE(
                ...
                .remove_by_idx_fcn_u =
                    OBJLIST_REMOVE_BY_IDX_FCN_U(NMSettingIPConfig,
                                                nm_setting_ip_config_remove_routing_rule), ), ), ),
    PROPERTY_INFO(NM_SETTING_IP_CONFIG_IGNORE_AUTO_ROUTES,
                  DESCRIBE_DOC_NM_SETTING_IP6_CONFIG_IGNORE_AUTO_ROUTES,
                  .property_type = &_pt_gobject_bool, ),
    PROPERTY_INFO(NM_SETTING_IP_CONFIG_IGNORE_AUTO_DNS,
                  DESCRIBE_DOC_NM_SETTING_IP6_CONFIG_IGNORE_AUTO_DNS,
                  .property_type = &_pt_gobject_bool, ),
    PROPERTY_INFO(NM_SETTING_IP_CONFIG_NEVER_DEFAULT,
                  DESCRIBE_DOC_NM_SETTING_IP6_CONFIG_NEVER_DEFAULT,
                  .property_type = &_pt_gobject_bool, ),
    PROPERTY_INFO(NM_SETTING_IP_CONFIG_MAY_FAIL,
                  DESCRIBE_DOC_NM_SETTING_IP6_CONFIG_MAY_FAIL,
                  .property_type = &_pt_gobject_bool, ),
    ...
    PROPERTY_INFO_WITH_DESC(
        ...
        .property_typ_data = DEFINE_PROPERTY_TYP_DATA(
            ...
            .typ_flags = NM_META_PROPERTY_TYP_FLAG_ENUM_GET_PARSABLE_TEXT
                         | NM_META_PROPERTY_TYP_FLAG_ENUM_GET_PRETTY_TEXT, ), ),
    PROPERTY_INFO(NM_SETTING_IP6_CONFIG_RA_TIMEOUT,
                  DESCRIBE_DOC_NM_SETTING_IP6_CONFIG_RA_TIMEOUT,
                  .property_type     = &_pt_gobject_int,
                  .property_typ_data = &_ptd_gobject_int_timeout, ),
    PROPERTY_INFO(NM_SETTING_IP6_CONFIG_DHCP_DUID,
                  DESCRIBE_DOC_NM_SETTING_IP6_CONFIG_DHCP_DUID,
                  .property_type = &_pt_gobject_string, ),
    PROPERTY_INFO(NM_SETTING_IP_CONFIG_DHCP_IAID,
                  DESCRIBE_DOC_NM_SETTING_IP6_CONFIG_DHCP_IAID,
                  .property_type = &_pt_gobject_string, ),
    PROPERTY_INFO(NM_SETTING_IP_CONFIG_DHCP_TIMEOUT,
                  DESCRIBE_DOC_NM_SETTING_IP6_CONFIG_DHCP_TIMEOUT,
                  .property_type     = &_pt_gobject_int,
                  .property_typ_data = &_ptd_gobject_int_timeout, ),
    PROPERTY_INFO(NM_SETTING_IP_CONFIG_DHCP_SEND_HOSTNAME,
                  DESCRIBE_DOC_NM_SETTING_IP6_CONFIG_DHCP_SEND_HOSTNAME,
                  .property_type = &_pt_gobject_bool, ),
    PROPERTY_INFO(NM_SETTING_IP_CONFIG_DHCP_HOSTNAME,
                  DESCRIBE_DOC_NM_SETTING_IP6_CONFIG_DHCP_HOSTNAME,
                  .property_type = &_pt_gobject_string, ),
    PROPERTY_INFO(NM_SETTING_IP_CONFIG_DHCP_HOSTNAME_FLAGS,
                  DESCRIBE_DOC_NM_SETTING_IP6_CONFIG_DHCP_HOSTNAME_FLAGS,
                  .property_type     = &_pt_gobject_enum,
                  .property_typ_data = DEFINE_PROPERTY_TYP_DATA(
                      PROPERTY_TYP_DATA_SUBTYPE(gobject_enum,
                                                .get_gtype = nm_dhcp_hostname_flags_get_type, ), )),
    PROPERTY_INFO_WITH_DESC(NM_SETTING_IP6_CONFIG_TOKEN, .property_type = &_pt_gobject_string, ),
    NULL};
...
static const NMMetaPropertyInfo *const property_infos_IP_TUNNEL[] = {
    ...
    PROPERTY_INFO_WITH_DESC(NM_SETTING_IP_TUNNEL_REMOTE,
                            ...
                            .prompt         = N_("Remote"),
                            .property_type  = &_pt_gobject_string, ),
    PROPERTY_INFO_WITH_DESC(NM_SETTING_IP_TUNNEL_TTL, .property_type = &_pt_gobject_int, ),
    PROPERTY_INFO_WITH_DESC(NM_SETTING_IP_TUNNEL_TOS, .property_type = &_pt_gobject_int, ),
    PROPERTY_INFO_WITH_DESC(NM_SETTING_IP_TUNNEL_PATH_MTU_DISCOVERY,
                            .property_type = &_pt_gobject_bool, ),
    PROPERTY_INFO_WITH_DESC(NM_SETTING_IP_TUNNEL_INPUT_KEY, .property_type = &_pt_gobject_string, ),
    PROPERTY_INFO_WITH_DESC(NM_SETTING_IP_TUNNEL_OUTPUT_KEY,
                            .property_type = &_pt_gobject_string, ),
    PROPERTY_INFO_WITH_DESC(NM_SETTING_IP_TUNNEL_ENCAPSULATION_LIMIT,
                            .property_type = &_pt_gobject_int, ),
    PROPERTY_INFO_WITH_DESC(NM_SETTING_IP_TUNNEL_FLOW_LABEL, .property_type = &_pt_gobject_int, ),
    PROPERTY_INFO_WITH_DESC(NM_SETTING_IP_TUNNEL_MTU, .property_type = &_pt_gobject_mtu, ),
    PROPERTY_INFO_WITH_DESC(
...
static const NMMetaPropertyInfo *const property_infos_MACSEC[] = {
    ...
    PROPERTY_INFO_WITH_DESC(
        ...
        .property_type     = &_pt_gobject_enum,
        .property_typ_data = DEFINE_PROPERTY_TYP_DATA(
            PROPERTY_TYP_DATA_SUBTYPE(gobject_enum, .get_gtype = nm_setting_macsec_mode_get_type, ),
            .typ_flags = NM_META_PROPERTY_TYP_FLAG_ENUM_GET_PARSABLE_TEXT
                         | NM_META_PROPERTY_TYP_FLAG_ENUM_GET_PRETTY_TEXT, ), ),
    ...
    PROPERTY_INFO_WITH_DESC(
        ...
        .property_typ_data = DEFINE_PROPERTY_TYP_DATA(
            ...
            .typ_flags = NM_META_PROPERTY_TYP_FLAG_ENUM_GET_PARSABLE_TEXT
                         | NM_META_PROPERTY_TYP_FLAG_ENUM_GET_PRETTY_TEXT, ), ),
    PROPERTY_INFO_WITH_DESC(NM_SETTING_MACSEC_SEND_SCI, .property_type = &_pt_gobject_bool, ),
    NULL};
...
static const NMMetaPropertyInfo *const property_infos_MACVLAN[] = {
    ...
    PROPERTY_INFO_WITH_DESC(NM_SETTING_MACVLAN_MODE,
                            ...
                            .property_typ_data = DEFINE_PROPERTY_TYP_DATA_SUBTYPE(
                                ...
                                .max       = G_MAXINT, ), ),
    PROPERTY_INFO_WITH_DESC(NM_SETTING_MACVLAN_PROMISCUOUS, .property_type = &_pt_gobject_bool, ),
    ...
    PROPERTY_INFO_WITH_DESC(
        ...
        .property_typ_data = DEFINE_PROPERTY_TYP_DATA(
            PROPERTY_TYP_DATA_SUBTYPE(
                ...
                .remove_by_idx_fcn_s =
                    MULTILIST_REMOVE_BY_IDX_FCN_S(NMSettingMatch,
    ...
    PROPERTY_INFO_WITH_DESC(
        ...
        .property_typ_data = DEFINE_PROPERTY_TYP_DATA(
            PROPERTY_TYP_DATA_SUBTYPE(
                multilist,
                .get_num_fcn_u =
                    MULTILIST_GET_NUM_FCN_U(NMSettingMatch,
                                            nm_setting_match_get_num_kernel_command_lines),
                .add2_fcn =
                    MULTILIST_ADD2_FCN(NMSettingMatch, nm_setting_match_add_kernel_command_line),
                .remove_by_idx_fcn_u =
                    MULTILIST_REMOVE_BY_IDX_FCN_U(NMSettingMatch,
    ...
    PROPERTY_INFO_WITH_DESC(
        ...
        .property_typ_data = DEFINE_PROPERTY_TYP_DATA(
            PROPERTY_TYP_DATA_SUBTYPE(
                multilist,
                .get_num_fcn_u =
                    MULTILIST_GET_NUM_FCN_U(NMSettingMatch, nm_setting_match_get_num_drivers),
                .add2_fcn = MULTILIST_ADD2_FCN(NMSettingMatch, nm_setting_match_add_driver),
                .remove_by_idx_fcn_u =
                    MULTILIST_REMOVE_BY_IDX_FCN_U(NMSettingMatch, nm_setting_match_remove_driver),
                .remove_by_value_fcn =
                    MULTILIST_REMOVE_BY_VALUE_FCN(NMSettingMatch,
    ...
    PROPERTY_INFO_WITH_DESC(
        ...
        .property_typ_data = DEFINE_PROPERTY_TYP_DATA(
            PROPERTY_TYP_DATA_SUBTYPE(
                multilist,
                .get_num_fcn_u =
                    MULTILIST_GET_NUM_FCN_U(NMSettingMatch, nm_setting_match_get_num_paths),
                .add2_fcn = MULTILIST_ADD2_FCN(NMSettingMatch, nm_setting_match_add_path),
                .remove_by_idx_fcn_u =
                    MULTILIST_REMOVE_BY_IDX_FCN_U(NMSettingMatch, nm_setting_match_remove_path),
                .remove_by_value_fcn =
                    MULTILIST_REMOVE_BY_VALUE_FCN(NMSettingMatch,
...
static const NMMetaPropertyInfo *const property_infos_OLPC_MESH[] = {
    PROPERTY_INFO_WITH_DESC(NM_SETTING_OLPC_MESH_SSID,
                            ...
                            .prompt         = N_("SSID"),
                            .property_type =
                                DEFINE_PROPERTY_TYPE(.get_fcn = _get_fcn_olpc_mesh_ssid,
...
static const NMMetaPropertyInfo *const property_infos_OVS_BRIDGE[] = {
    PROPERTY_INFO_WITH_DESC(
        ...
        .property_type = &_pt_gobject_string,
        .property_typ_data =
            DEFINE_PROPERTY_TYP_DATA(.values_static = NM_MAKE_STRV("secure", "standalone"), ), ),
    ...
    PROPERTY_INFO_WITH_DESC(NM_SETTING_OVS_BRIDGE_RSTP_ENABLE,
                            .property_type = &_pt_gobject_bool, ),
    PROPERTY_INFO_WITH_DESC(NM_SETTING_OVS_BRIDGE_STP_ENABLE, .property_type = &_pt_gobject_bool, ),
    PROPERTY_INFO_WITH_DESC(
        NM_SETTING_OVS_BRIDGE_DATAPATH_TYPE,
        .property_type = &_pt_gobject_string,
        .property_typ_data =
            DEFINE_PROPERTY_TYP_DATA(.values_static = NM_MAKE_STRV("system", "netdev"), ), ),
    NULL};
...
static const NMMetaPropertyInfo *const property_infos_OVS_DPDK[] = {
    PROPERTY_INFO_WITH_DESC(NM_SETTING_OVS_DPDK_DEVARGS, .property_type = &_pt_gobject_string, ),
    NULL};
...
static const NMMetaPropertyInfo *const property_infos_OVS_INTERFACE[] = {
    PROPERTY_INFO_WITH_DESC(
        ...
        .property_typ_data =
            DEFINE_PROPERTY_TYP_DATA(.values_static =
                                         NM_MAKE_STRV("internal", "system", "patch", "dpdk"), ), ),
    NULL};
...
static const NMMetaPropertyInfo *const property_infos_OVS_PATCH[] = {
    PROPERTY_INFO_WITH_DESC(NM_SETTING_OVS_PATCH_PEER, .property_type = &_pt_gobject_string, ),
    NULL};
...
static const NMMetaPropertyInfo *const property_infos_OVS_PORT[] = {
    PROPERTY_INFO_WITH_DESC(
        ...
        .property_typ_data = DEFINE_PROPERTY_TYP_DATA(
                .values_static =
                    NM_MAKE_STRV("access", "native-tagged", "native-untagged", "trunk"), ), ),
    PROPERTY_INFO_WITH_DESC(NM_SETTING_OVS_PORT_TAG, .property_type = &_pt_gobject_int, ),
    ...
    PROPERTY_INFO_WITH_DESC(NM_SETTING_OVS_PORT_BOND_UPDELAY, .property_type = &_pt_gobject_int, ),
...
static const NMMetaPropertyInfo *const property_infos_PPP[] = {
    PROPERTY_INFO_WITH_DESC(NM_SETTING_PPP_NOAUTH, .property_type = &_pt_gobject_bool, ),
    PROPERTY_INFO_WITH_DESC(NM_SETTING_PPP_REFUSE_EAP, .property_type = &_pt_gobject_bool, ),
    PROPERTY_INFO_WITH_DESC(NM_SETTING_PPP_REFUSE_PAP, .property_type = &_pt_gobject_bool, ),
    PROPERTY_INFO_WITH_DESC(NM_SETTING_PPP_REFUSE_CHAP, .property_type = &_pt_gobject_bool, ),
    PROPERTY_INFO_WITH_DESC(NM_SETTING_PPP_REFUSE_MSCHAP, .property_type = &_pt_gobject_bool, ),
    PROPERTY_INFO_WITH_DESC(NM_SETTING_PPP_REFUSE_MSCHAPV2, .property_type = &_pt_gobject_bool, ),
    PROPERTY_INFO_WITH_DESC(NM_SETTING_PPP_NOBSDCOMP, .property_type = &_pt_gobject_bool, ),
    PROPERTY_INFO_WITH_DESC(NM_SETTING_PPP_NODEFLATE, .property_type = &_pt_gobject_bool, ),
    PROPERTY_INFO_WITH_DESC(NM_SETTING_PPP_NO_VJ_COMP, .property_type = &_pt_gobject_bool, ),
    PROPERTY_INFO_WITH_DESC(NM_SETTING_PPP_REQUIRE_MPPE, .property_type = &_pt_gobject_bool, ),
    PROPERTY_INFO_WITH_DESC(NM_SETTING_PPP_REQUIRE_MPPE_128, .property_type = &_pt_gobject_bool, ),
    PROPERTY_INFO_WITH_DESC(NM_SETTING_PPP_MPPE_STATEFUL, .property_type = &_pt_gobject_bool, ),
    PROPERTY_INFO_WITH_DESC(NM_SETTING_PPP_CRTSCTS, .property_type = &_pt_gobject_bool, ),
    PROPERTY_INFO_WITH_DESC(NM_SETTING_PPP_BAUD, .property_type = &_pt_gobject_int, ),
    PROPERTY_INFO_WITH_DESC(NM_SETTING_PPP_MRU, .property_type = &_pt_gobject_int, ),
    PROPERTY_INFO_WITH_DESC(NM_SETTING_PPP_MTU,
                            .property_type     = &_pt_gobject_mtu,
                            .property_typ_data = DEFINE_PROPERTY_TYP_DATA_SUBTYPE(
                                mtu,
                                .get_fcn = MTU_GET_FCN(NMSettingPpp, nm_setting_ppp_get_mtu), ), ),
    PROPERTY_INFO_WITH_DESC(NM_SETTING_PPP_LCP_ECHO_FAILURE, .property_type = &_pt_gobject_int, ),
    PROPERTY_INFO_WITH_DESC(NM_SETTING_PPP_LCP_ECHO_INTERVAL, .property_type = &_pt_gobject_int, ),
    NULL};
...
static const NMMetaPropertyInfo *const property_infos_SERIAL[] = {
    PROPERTY_INFO_WITH_DESC(NM_SETTING_SERIAL_BAUD, .property_type = &_pt_gobject_int, ),
    PROPERTY_INFO_WITH_DESC(NM_SETTING_SERIAL_BITS, .property_type = &_pt_gobject_int, ),
    PROPERTY_INFO_WITH_DESC(
        ...
        .property_typ_data = DEFINE_PROPERTY_TYP_DATA(
            ...
            .typ_flags = NM_META_PROPERTY_TYP_FLAG_ENUM_GET_PARSABLE_TEXT
                         | NM_META_PROPERTY_TYP_FLAG_ENUM_GET_PRETTY_TEXT, ), ),
    PROPERTY_INFO_WITH_DESC(NM_SETTING_SERIAL_STOPBITS, .property_type = &_pt_gobject_int, ),
    PROPERTY_INFO_WITH_DESC(NM_SETTING_SERIAL_SEND_DELAY, .property_type = &_pt_gobject_int, ),
    NULL};
...
static const NMMetaPropertyInfo *const property_infos_SRIOV[] = {
    PROPERTY_INFO_WITH_DESC(NM_SETTING_SRIOV_TOTAL_VFS, .property_type = &_pt_gobject_int, ),
    PROPERTY_INFO_WITH_DESC(
...
static const NMMetaPropertyInfo *const property_infos_TC_CONFIG[] = {
    PROPERTY_INFO(NM_SETTING_TC_CONFIG_QDISCS,
                  DESCRIBE_DOC_NM_SETTING_TC_CONFIG_QDISCS,
                  .property_type     = &_pt_objlist,
                  .property_typ_data = DEFINE_PROPERTY_TYP_DATA(
                      PROPERTY_TYP_DATA_SUBTYPE(
                          objlist,
                          .get_num_fcn    = OBJLIST_GET_NUM_FCN(NMSettingTCConfig,
                                                             nm_setting_tc_config_get_num_qdiscs),
                          .clear_all_fcn  = OBJLIST_CLEAR_ALL_FCN(NMSettingTCConfig,
                          ...
                          .remove_by_idx_fcn_u =
                              OBJLIST_REMOVE_BY_IDX_FCN_U(NMSettingTCConfig,
    ...
    PROPERTY_INFO(
        ...
        .property_typ_data = DEFINE_PROPERTY_TYP_DATA(
            PROPERTY_TYP_DATA_SUBTYPE(
                objlist,
                .get_num_fcn =
                    OBJLIST_GET_NUM_FCN(NMSettingTCConfig, nm_setting_tc_config_get_num_tfilters),
                .clear_all_fcn =
                    OBJLIST_CLEAR_ALL_FCN(NMSettingTCConfig, nm_setting_tc_config_clear_tfilters),
...
static const NMMetaPropertyInfo *const property_infos_TEAM[] = {
    ...
    PROPERTY_INFO_WITH_DESC(
        ...
        .property_typ_data = DEFINE_PROPERTY_TYP_DATA(
            PROPERTY_TYP_DATA_SUBTYPE(
                multilist,
                .get_num_fcn_u =
                    MULTILIST_GET_NUM_FCN_U(NMSettingTeam, nm_setting_team_get_num_runner_tx_hash),
                .add_fcn = MULTILIST_ADD_FCN(NMSettingTeam, nm_setting_team_add_runner_tx_hash),
                .remove_by_idx_fcn_u =
                    MULTILIST_REMOVE_BY_IDX_FCN_U(NMSettingTeam,
                                                  nm_setting_team_remove_runner_tx_hash),
                .remove_by_value_fcn =
                    MULTILIST_REMOVE_BY_VALUE_FCN(NMSettingTeam,
                                                  nm_setting_team_remove_runner_tx_hash_by_value),
                .strsplit_plain = TRUE, ),
            .values_static = NM_MAKE_STRV("eth",
                                          "vlan",
                                          "ipv4",
                                          "ipv6",
                                          "ip",
    ...
    PROPERTY_INFO_WITH_DESC(
        ...
        .property_type     = &_pt_gobject_string,
        .property_typ_data = DEFINE_PROPERTY_TYP_DATA(.values_static = NM_MAKE_STRV("basic"), ), ),
    PROPERTY_INFO_WITH_DESC(
    ...
    PROPERTY_INFO_WITH_DESC(NM_SETTING_TEAM_RUNNER_ACTIVE, .property_type = &_pt_gobject_bool, ),
    PROPERTY_INFO_WITH_DESC(NM_SETTING_TEAM_RUNNER_FAST_RATE, .property_type = &_pt_gobject_bool, ),
    ...
    PROPERTY_INFO_WITH_DESC(
        ...
        .property_typ_data = DEFINE_PROPERTY_TYP_DATA(
            PROPERTY_TYP_DATA_SUBTYPE(
                objlist,
                .get_num_fcn =
                    OBJLIST_GET_NUM_FCN(NMSettingTeam, nm_setting_team_get_num_link_watchers),
                .obj_to_str_fcn = _objlist_obj_to_str_fcn_team_link_watchers,
                .set_fcn        = _objlist_set_fcn_team_link_watchers,
                .remove_by_idx_fcn_u =
                    OBJLIST_REMOVE_BY_IDX_FCN_U(NMSettingTeam,
...
static const NMMetaPropertyInfo *const property_infos_TEAM_PORT[] = {
    ...
    PROPERTY_INFO_WITH_DESC(NM_SETTING_TEAM_PORT_STICKY, .property_type = &_pt_gobject_bool, ),
    ...
    PROPERTY_INFO_WITH_DESC(
        ...
        .property_typ_data = DEFINE_PROPERTY_TYP_DATA(
            PROPERTY_TYP_DATA_SUBTYPE(
                objlist,
                .get_num_fcn    = OBJLIST_GET_NUM_FCN(NMSettingTeamPort,
                                                   nm_setting_team_port_get_num_link_watchers),
                .obj_to_str_fcn = _objlist_obj_to_str_fcn_team_link_watchers,
                .set_fcn        = _objlist_set_fcn_team_link_watchers,
                .remove_by_idx_fcn_u =
                    OBJLIST_REMOVE_BY_IDX_FCN_U(NMSettingTeamPort,
...
static const NMMetaPropertyInfo *const property_infos_VLAN[] = {
    ...
    PROPERTY_INFO_WITH_DESC(NM_SETTING_VLAN_FLAGS,
                            ...
                            .property_type =
                                DEFINE_PROPERTY_TYPE(.get_fcn = _get_fcn_vlan_flags,
    ...
    PROPERTY_INFO_WITH_DESC(NM_SETTING_VLAN_INGRESS_PRIORITY_MAP,
                            ...
                            .property_type =
                                DEFINE_PROPERTY_TYPE(.get_fcn = _get_fcn_vlan_xgress_priority_map,
...
static const NMMetaPropertyInfo *const property_infos_VPN[] = {
    ...
    PROPERTY_INFO_WITH_DESC(NM_SETTING_VPN_DATA,
                            .property_type = DEFINE_PROPERTY_TYPE(.get_fcn = _get_fcn_vpn_options,
                                                                  .set_fcn = _set_fcn_optionlist,
                                                                  .set_supports_remove = TRUE, ),
                            .property_typ_data = DEFINE_PROPERTY_TYP_DATA_SUBTYPE(
                                optionlist,
    ...
    PROPERTY_INFO_WITH_DESC(NM_SETTING_VPN_PERSISTENT, .property_type = &_pt_gobject_bool, ),
    PROPERTY_INFO_WITH_DESC(NM_SETTING_VPN_TIMEOUT, .property_type = &_pt_gobject_int, ),
    NULL};
...
static const NMMetaPropertyInfo *const property_infos_VXLAN[] = {
    ...
    PROPERTY_INFO_WITH_DESC(NM_SETTING_VXLAN_DESTINATION_PORT,
                            ...
                            .property_type  = &_pt_gobject_int, ),
    PROPERTY_INFO_WITH_DESC(NM_SETTING_VXLAN_TOS, .property_type = &_pt_gobject_int, ),
    PROPERTY_INFO_WITH_DESC(NM_SETTING_VXLAN_TTL, .property_type = &_pt_gobject_int, ),
    PROPERTY_INFO_WITH_DESC(NM_SETTING_VXLAN_AGEING, .property_type = &_pt_gobject_int, ),
    PROPERTY_INFO_WITH_DESC(NM_SETTING_VXLAN_LIMIT, .property_type = &_pt_gobject_int, ),
    PROPERTY_INFO_WITH_DESC(NM_SETTING_VXLAN_LEARNING, .property_type = &_pt_gobject_bool, ),
    PROPERTY_INFO_WITH_DESC(NM_SETTING_VXLAN_PROXY, .property_type = &_pt_gobject_bool, ),
    PROPERTY_INFO_WITH_DESC(NM_SETTING_VXLAN_RSC, .property_type = &_pt_gobject_bool, ),
    PROPERTY_INFO_WITH_DESC(NM_SETTING_VXLAN_L2_MISS, .property_type = &_pt_gobject_bool, ),
    PROPERTY_INFO_WITH_DESC(NM_SETTING_VXLAN_L3_MISS, .property_type = &_pt_gobject_bool, ),
    NULL};
...
static const NMMetaPropertyInfo *const property_infos_WIFI_P2P[] = {
    ...
    PROPERTY_INFO_WITH_DESC(NM_SETTING_WIFI_P2P_WFD_IES, .property_type = &_pt_gobject_bytes, ),
    NULL};
...
static const NMMetaPropertyInfo *const property_infos_WIRED[] = {
    PROPERTY_INFO_WITH_DESC(NM_SETTING_WIRED_PORT,
	     ...
	     */
                            .property_type = &_pt_gobject_readonly, ),
    PROPERTY_INFO_WITH_DESC(NM_SETTING_WIRED_SPEED, .property_type = &_pt_gobject_int, ),
    PROPERTY_INFO_WITH_DESC(
        NM_SETTING_WIRED_DUPLEX,
        .property_type = &_pt_gobject_string,
        .property_typ_data =
            DEFINE_PROPERTY_TYP_DATA(.values_static = NM_MAKE_STRV("half", "full"), ), ),
    PROPERTY_INFO_WITH_DESC(NM_SETTING_WIRED_AUTO_NEGOTIATE, .property_type = &_pt_gobject_bool, ),
    ...
    PROPERTY_INFO_WITH_DESC(
        ...
        .property_typ_data = DEFINE_PROPERTY_TYP_DATA(
            PROPERTY_TYP_DATA_SUBTYPE(
                multilist,
                .get_num_fcn_u32 =
                    MULTILIST_GET_NUM_FCN_U32(NMSettingWired,
                                              nm_setting_wired_get_num_mac_blacklist_items),
                .add_fcn =
                    MULTILIST_ADD_FCN(NMSettingWired, nm_setting_wired_add_mac_blacklist_item),
                .remove_by_idx_fcn_u32 =
                    MULTILIST_REMOVE_BY_IDX_FCN_U32(NMSettingWired,
    ...
    PROPERTY_INFO_WITH_DESC(
        ...
        .describe_message = N_("Enter a list of subchannels (comma or space separated).\n\n"
    ...
    PROPERTY_INFO_WITH_DESC(
        ...
        .property_type = &_pt_gobject_string,
        .property_typ_data =
            DEFINE_PROPERTY_TYP_DATA(.values_static = NM_MAKE_STRV("qeth", "lcs", "ctc"), ), ),
    PROPERTY_INFO_WITH_DESC(
        ...
        .property_typ_data =
            DEFINE_PROPERTY_TYP_DATA_SUBTYPE(optionlist,
...
static const NMMetaPropertyInfo *const property_infos_WIREGUARD[] = {
    ...
    PROPERTY_INFO_WITH_DESC(NM_SETTING_WIREGUARD_PRIVATE_KEY_FLAGS,
                            .property_type = &_pt_gobject_secret_flags, ),
    PROPERTY_INFO_WITH_DESC(NM_SETTING_WIREGUARD_LISTEN_PORT, .property_type = &_pt_gobject_int, ),
    PROPERTY_INFO_WITH_DESC(NM_SETTING_WIREGUARD_FWMARK,
                            .property_type = &_pt_gobject_int,
                            .property_typ_data =
                                DEFINE_PROPERTY_TYP_DATA_SUBTYPE(gobject_int, .base = 16, ), ),
    PROPERTY_INFO_WITH_DESC(NM_SETTING_WIREGUARD_PEER_ROUTES, .property_type = &_pt_gobject_bool, ),
    PROPERTY_INFO_WITH_DESC(NM_SETTING_WIREGUARD_MTU, .property_type = &_pt_gobject_mtu, ),
...
static const NMMetaPropertyInfo *const property_infos_WIRELESS[] = {
    PROPERTY_INFO_WITH_DESC(NM_SETTING_WIRELESS_SSID,
                            ...
                            .prompt         = N_("SSID"),
                            .property_type =
                                DEFINE_PROPERTY_TYPE(.get_fcn = _get_fcn_wireless_ssid,
                                                     .set_fcn = _set_fcn_gobject_ssid, ), ),
    ...
    PROPERTY_INFO_WITH_DESC(
        ...
        .property_type = &_pt_gobject_string,
        .property_typ_data =
            DEFINE_PROPERTY_TYP_DATA(.values_static = NM_MAKE_STRV("a", "bg"), ), ),
    PROPERTY_INFO_WITH_DESC(NM_SETTING_WIRELESS_CHANNEL,
                            .property_type =
                                DEFINE_PROPERTY_TYPE(.get_fcn = _get_fcn_gobject,
                                                     .set_fcn = _set_fcn_wireless_channel, ), ),
    PROPERTY_INFO_WITH_DESC(NM_SETTING_WIRELESS_BSSID, .property_type = &_pt_gobject_mac, ),
    ...
    PROPERTY_INFO_WITH_DESC(
        ...
        .property_typ_data = DEFINE_PROPERTY_TYP_DATA(
            PROPERTY_TYP_DATA_SUBTYPE(
                multilist,
                .get_num_fcn_u32 =
                    MULTILIST_GET_NUM_FCN_U32(NMSettingWireless,
                                              nm_setting_wireless_get_num_mac_blacklist_items),
                .add_fcn = MULTILIST_ADD_FCN(NMSettingWireless,
                                             nm_setting_wireless_add_mac_blacklist_item),
                .remove_by_idx_fcn_u32 =
                    MULTILIST_REMOVE_BY_IDX_FCN_U32(NMSettingWireless,
    ...
    PROPERTY_INFO_WITH_DESC(NM_SETTING_WIRELESS_SEEN_BSSIDS,
                            .property_type = &_pt_gobject_readonly, ),
    PROPERTY_INFO_WITH_DESC(NM_SETTING_WIRELESS_HIDDEN, .property_type = &_pt_gobject_bool, ),
    PROPERTY_INFO_WITH_DESC(
    ...
    PROPERTY_INFO_WITH_DESC(NM_SETTING_WIRELESS_AP_ISOLATION, .property_type = &_pt_gobject_enum, ),
    NULL};
...
static const NMMetaPropertyInfo *const property_infos_WIRELESS_SECURITY[] = {
    PROPERTY_INFO_WITH_DESC(
        ...
        .property_typ_data = DEFINE_PROPERTY_TYP_DATA(
                .values_static =
                    NM_MAKE_STRV("none", "ieee8021x", "wpa-psk", "wpa-eap", "sae", "owe"), ), ),
    ...
    PROPERTY_INFO_WITH_DESC(
        ...
        .property_type = &_pt_gobject_string,
        .property_typ_data =
            DEFINE_PROPERTY_TYP_DATA(.values_static = NM_MAKE_STRV("open", "shared", "leap"), ), ),
    PROPERTY_INFO_WITH_DESC(
        ...
        .property_typ_data = DEFINE_PROPERTY_TYP_DATA(
            PROPERTY_TYP_DATA_SUBTYPE(
                multilist,
                .get_num_fcn_u32 =
                    MULTILIST_GET_NUM_FCN_U32(NMSettingWirelessSecurity,
                                              nm_setting_wireless_security_get_num_protos),
                .add_fcn = MULTILIST_ADD_FCN(NMSettingWirelessSecurity,
                                             nm_setting_wireless_security_add_proto),
                .remove_by_idx_fcn_u32 =
                    MULTILIST_REMOVE_BY_IDX_FCN_U32(NMSettingWirelessSecurity,
    ...
    PROPERTY_INFO_WITH_DESC(NM_SETTING_WIRELESS_SECURITY_WEP_KEY0,
                            .is_secret = TRUE,
                            .property_type =
                                DEFINE_PROPERTY_TYPE(.get_fcn = _get_fcn_wireless_security_wep_key,
    ...
    PROPERTY_INFO_WITH_DESC(
        NM_SETTING_WIRELESS_SECURITY_WEP_KEY_TYPE,
        .describe_message  = N_("Enter the type of WEP keys. The accepted values are: "
...
static const NMMetaPropertyInfo *const property_infos_WPAN[] = {
    PROPERTY_INFO_WITH_DESC(
        ...
        .prompt         = N_("MAC [none]"),
        .property_typ_data =
            DEFINE_PROPERTY_TYP_DATA_SUBTYPE(mac, .mode = NM_META_PROPERTY_TYPE_MAC_MODE_WPAN, ), ),
...
static void _setting_init_fcn_cdma(ARGS_SETTING_INIT_FCN)
{
    if (init_type == NM_META_ACCESSOR_SETTING_INIT_TYPE_CLI) {
        /* Initialize 'number' so that 'cdma' is valid */
        g_object_set(NM_SETTING_CDMA(setting), NM_SETTING_CDMA_NUMBER, "#777", NULL);
    }
}

static void _setting_init_fcn_gsm(ARGS_SETTING_INIT_FCN)
{
    if (init_type == NM_META_ACCESSOR_SETTING_INIT_TYPE_CLI) {
        /* Initialize 'apn' so that 'gsm' is valid */
        g_object_set(NM_SETTING_GSM(setting), NM_SETTING_GSM_APN, "internet", NULL);
    }
}

static void _setting_init_fcn_infiniband(ARGS_SETTING_INIT_FCN)
{
    if (init_type == NM_META_ACCESSOR_SETTING_INIT_TYPE_CLI) {
...
static void _setting_init_fcn_ip4_config(ARGS_SETTING_INIT_FCN)
{
    if (init_type == NM_META_ACCESSOR_SETTING_INIT_TYPE_CLI) {
...
static void _setting_init_fcn_ip6_config(ARGS_SETTING_INIT_FCN)
{
    if (init_type == NM_META_ACCESSOR_SETTING_INIT_TYPE_CLI) {
        g_object_set(NM_SETTING_IP_CONFIG(setting),
                     NM_SETTING_IP_CONFIG_METHOD,
...
static void _setting_init_fcn_olpc_mesh(ARGS_SETTING_INIT_FCN)
{
    if (init_type == NM_META_ACCESSOR_SETTING_INIT_TYPE_CLI) {
        g_object_set(NM_SETTING_OLPC_MESH(setting), NM_SETTING_OLPC_MESH_CHANNEL, 1, NULL);
    }
}

static void _setting_init_fcn_proxy(ARGS_SETTING_INIT_FCN)
{
    if (init_type == NM_META_ACCESSOR_SETTING_INIT_TYPE_CLI) {
        g_object_set(NM_SETTING_PROXY(setting),
                     NM_SETTING_PROXY_METHOD,
                     (int) NM_SETTING_PROXY_METHOD_NONE,
                     NULL);
    }
}

static void _setting_init_fcn_tun(ARGS_SETTING_INIT_FCN)
{
    if (init_type == NM_META_ACCESSOR_SETTING_INIT_TYPE_CLI) {
        g_object_set(NM_SETTING_TUN(setting), NM_SETTING_TUN_MODE, NM_SETTING_TUN_MODE_TUN, NULL);
    }
}

static void _setting_init_fcn_vlan(ARGS_SETTING_INIT_FCN)
{
    if (init_type == NM_META_ACCESSOR_SETTING_INIT_TYPE_CLI) {
        g_object_set(setting, NM_SETTING_VLAN_ID, 1, NULL);
    }
}

static void _setting_init_fcn_wireless(ARGS_SETTING_INIT_FCN)
{
    if (init_type == NM_META_ACCESSOR_SETTING_INIT_TYPE_CLI) {
...
#define SETTING_INFO_EMPTY(type, ...)                                                \
    [NM_META_SETTING_TYPE_##                                                         \
        type] = {.meta_type   = &nm_meta_type_setting_info_editor,                   \
...
#define SETTING_INFO(type, ...)                                                         \
    ...
    SETTING_INFO(ADSL,
                 .valid_parts =
                     NM_META_SETTING_VALID_PARTS(NM_META_SETTING_VALID_PART_ITEM(CONNECTION, TRUE),
    ...
    SETTING_INFO(IP4_CONFIG, .setting_init_fcn = _setting_init_fcn_ip4_config, ),
    SETTING_INFO(IP6_CONFIG, .setting_init_fcn = _setting_init_fcn_ip6_config, ),
    ...
    SETTING_INFO(PPPOE,
	     ...
	     */
                 .valid_parts = NM_META_SETTING_VALID_PARTS(
                     ...
                     NM_META_SETTING_VALID_PART_ITEM(ETHTOOL, FALSE), ), ),
    SETTING_INFO(PPP),
    SETTING_INFO(PROXY, .setting_init_fcn = _setting_init_fcn_proxy, ),
    SETTING_INFO(SERIAL),
    SETTING_INFO(SRIOV),
    ...
    SETTING_INFO(WIRELESS_SECURITY, .alias = "wifi-sec", ),
    SETTING_INFO(WPAN,
                 .valid_parts =
                     NM_META_SETTING_VALID_PARTS(NM_META_SETTING_VALID_PART_ITEM(CONNECTION, TRUE),
